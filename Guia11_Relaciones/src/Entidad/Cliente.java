...
public class Cliente {
    ...
    public Cliente(String nombre, String apellido, String mail, String domicilio, Integer documento, Integer telefono) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Cliente{" + "nombre=" + nombre + ", apellido=" + apellido + ", mail=" + mail + ", domicilio=" + domicilio + ", documento=" + documento + ", telefono=" + telefono + '}';
    }
